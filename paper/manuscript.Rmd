...
\begin{figure*}[ht]
\centering
\includegraphics[width = 7in, height = 3in]{rsdb_map_marine}
\caption{\textbf{Empirical evidence of regime shifts}. Over 1440 marine regime shifts are documented on the regime shifts database, 788 cases are of hypoxia, followed by marine eutrophication (245) and fisheries collapse (181). For each dot in the map there is a paper in the scientific literature reporting regime shifts in marine ecosystems. Source: www.regimeshifts.org (beta version at www.regimeshifts.netlify.app).} 
\label{fig:rsdb}
\end{figure*}
