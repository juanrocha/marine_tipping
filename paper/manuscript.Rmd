...
24% of the area analysed with early warning signals (limited to the 50$^\circ$ N-50$^\circ$ S region due to data availability) show symptoms of resilience loss[@Rocha_2022].
...
Our change point analysis shows that there has been abrupt changes in primary productivity (Fig \ref{fig:break_point}).
The extend of the area varies depending on the statistical test used.
The Pettitt test look for changes in means, and detects significant changes in 50% of the oceans with break points in early 2000s in the south Pacific, and more recent changes in the rest of the world.
...
The implications of this result is that the relevant decisions to manage tipping point risk are not only on the hands of fishing vessels, the companies that own them or their shareholders.
...
We found that XX% of the oceans are at risk of regime shifts, and provided evidence of past regime shifts from literature reviews, and abrupt change observed in primary productivity and stock assessments data.
...
The literature already showcase past events with impacts on employment and economic lossess on the millions of dollars.
So who is at risk today?

We found that only 0.15% (16,878) of the vessels tracked in Global Fish Wash do actually fish in areas susceptible to marine regime shifts.
